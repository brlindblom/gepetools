...
$ECHO
$ECHO "        Installation of start_mpich2 for Grid Engine PE"
$ECHO "        -----------------------------------------------"
$ECHO
$ECHO "This script should be called from the directory"
$ECHO
$ECHO "   \$SGE_ROOT/mpich2_mpd/src"
$ECHO
...
$ECHO "to"
$ECHO
$ECHO "   \$SGE_ROOT/mpich2_mpd/bin/<architecture>"
$ECHO
$ECHO "If you are using the templates" 
$ECHO 
$ECHO "   \$SGE_ROOT/mpich2_mpd/startmpich2.sh"
$ECHO "   \$SGE_ROOT/mpich2_mpd/stopmpich2.sh"
$ECHO 
$ECHO "for starting and stopping MPICH2's mpds (defined as \"start_proc_args\""
